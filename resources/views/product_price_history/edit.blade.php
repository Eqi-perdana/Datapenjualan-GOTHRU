                ...
                <form action="{{ route('product_price_history.update', $history->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="price_type" id="price_type" class="form-select" required>
                            <option value="purchase" {{ $history->price_type == 'purchase' ? 'selected' : '' }}>Harga Beli</option>
                            <option value="selling" {{ $history->price_type == 'selling' ? 'selected' : '' }}>Harga Jual</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="{{ $history->price }}" class="form-control" required>
                    </div>
